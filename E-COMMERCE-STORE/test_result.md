...
user_problem_statement: "build me a e commerce website and a admin panel to sell electricals and other items online by adding products and advertisement banner through admin panel and a intractive main website with razorpay payment integration cod and custom scanner payment option for direct payment help deploy both admin and frontend panel and backend on render with the database"
